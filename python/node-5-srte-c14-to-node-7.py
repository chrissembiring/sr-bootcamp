...
tn.write("segment-list 5-6-7\n")
tn.write("index 10 mpls label 16006\n")
tn.write("index 20 mpls label 16007\n")
tn.write("index 30 mpls label 74\n")
tn.write("policy c14-node7\n")
tn.write("color 14 end-point ipv4 1.1.1.4\n")
tn.write("candidate-paths\n")
tn.write("preference 100\n")
tn.write("explicit segment-list 5-6-7\n")
tn.write("commit\n")
tn.write("end\n")
