...
tn.write("distribute bgp-ls instance-id 2\n")
...
tn.write("prefix-sid absolute 16001\n")
...
tn.write("fast-reroute per-prefix\n")
tn.write("fast-reroute per-prefix ti-lfa enable\n")
tn.write("interface GigabitEthernet0/0/0/5\n")
tn.write("network point-to-point\n")
tn.write("fast-reroute per-prefix\n")
tn.write("fast-reroute per-prefix ti-lfa enable\n")
...
tn.write("fast-reroute per-prefix\n")
tn.write("fast-reroute per-prefix ti-lfa enable\n")
tn.write("interface GigabitEthernet0/0/0/4\n")
tn.write("network point-to-point\n")
tn.write("fast-reroute per-prefix\n")
tn.write("fast-reroute per-prefix ti-lfa enable\n")
tn.write("mpls traffic-eng router-id Loopback0\n")
